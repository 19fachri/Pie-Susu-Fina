...
public class ViewKeuangan extends javax.swing.JFrame {
    ...
    private void awal(){
        ...
        tabelKeuangan.setModel(k.getTableKeuangan());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/keuangan.png"))); // NOI18N
    ...
    private void tabelKeuanganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelKeuanganMouseClicked
        ...
        ViewDetailKeuangan vdk = new ViewDetailKeuangan();
        vdk.setVisible(true);
        vdk.awal(tabelKeuangan.getValueAt(tabelKeuangan.getSelectedRow(), 1).toString(), tabelKeuangan.getValueAt(tabelKeuangan.getSelectedRow(), 3).toString(), tabelKeuangan.getValueAt(tabelKeuangan.getSelectedRow(), 2).toString(), tabelKeuangan.getValueAt(tabelKeuangan.getSelectedRow(), 4).toString());
