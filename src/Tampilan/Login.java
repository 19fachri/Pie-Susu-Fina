...
public class Login extends javax.swing.JFrame {
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        // TODO add your handling code here:
        Pegawai p = new Pegawai(username.getText(), String.valueOf(password.getPassword()));
        if(p.login()){
            Menu m = new Menu();
            m.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(rootPane, "cek kembali username dan password anda");
        }
