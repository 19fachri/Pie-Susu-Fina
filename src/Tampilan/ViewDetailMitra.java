 ...
 * @author Admin
 */
public class ViewDetailMitra extends javax.swing.JFrame {

    /**
     * Creates new form ViewTambahMitra
     */
    public ViewDetailMitra() {
        initComponents();
    }
    
    public void awal(String i){
        id.setText(i);
        Mitra m = new Mitra();
        m.show(Integer.parseInt(i));
        nama.setText(m.getNama());
        pemilik.setText(m.getPemilik());
        kontak.setText(m.getKontak());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(m.update(Integer.parseInt(id.getText()))){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDetailMitra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDetailMitra().setVisible(true);
            }
        });
    }
